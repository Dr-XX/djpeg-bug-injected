...
ACLOCAL = ${SHELL} /home/jordan/tests/jpeg-9c/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AS = as
AUTOCONF = ${SHELL} /home/jordan/tests/jpeg-9c/missing autoconf
AUTOHEADER = echo autoheader ignored
AUTOMAKE = ${SHELL} /home/jordan/tests/jpeg-9c/missing automake-1.15
AWK = gawk
CC = gcc
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} /home/jordan/tests/jpeg-9c/missing makeinfo
MANIFEST_TOOL = :
MEMORYMGR = jmemnobs
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
...
STRIP = strip
VERSION = 9.3.0
abs_builddir = /home/jordan/tests/jpeg-9c
abs_srcdir = /home/jordan/tests/jpeg-9c
abs_top_builddir = /home/jordan/tests/jpeg-9c
abs_top_srcdir = /home/jordan/tests/jpeg-9c
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /home/jordan/tests/jpeg-9c/install-sh
...
pdfdir = ${docdir}
prefix = /home/jordan/tests/jpeg-9c/O0-g-install
